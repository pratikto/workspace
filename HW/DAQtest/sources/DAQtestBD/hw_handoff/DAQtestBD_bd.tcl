...
################################################################
# This is a generated script based on design: DAQtestBD
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./workspace/DAQtest/sources
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net DAQ_0_O_READY_0 [get_bd_pins DAQ_0/O_READY_0] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net DAQ_0_O_READY_1 [get_bd_pins DAQ_0/O_READY_1] [get_bd_pins xlconcat_0/In9]
