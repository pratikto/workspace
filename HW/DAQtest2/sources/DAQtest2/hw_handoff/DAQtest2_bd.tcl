...
################################################################
# This is a generated script based on design: DAQtest2
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net DAQ_0_O_A0 [get_bd_pins DAQ_0/O_A0] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net DAQ_0_O_A1 [get_bd_pins DAQ_0/O_A1] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net DAQ_0_O_ARM [get_bd_pins DAQ_0/O_ARM] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net DAQ_0_O_OVERFLOW_0 [get_bd_pins DAQ_0/O_OVERFLOW_0] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net DAQ_0_O_OVERFLOW_1 [get_bd_pins DAQ_0/O_OVERFLOW_1] [get_bd_pins xlconcat_0/In9]
  connect_bd_net -net DAQ_0_O_READY_0 [get_bd_pins DAQ_0/O_READY_0] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net DAQ_0_O_READY_1 [get_bd_pins DAQ_0/O_READY_1] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net DAQ_0_O_SEL [get_bd_pins DAQ_0/O_SEL] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net DAQ_0_O_Z0 [get_bd_pins DAQ_0/O_Z0] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net DAQ_0_O_Z1 [get_bd_pins DAQ_0/O_Z1] [get_bd_pins xlconcat_0/In7]
