...
//------------------------Parameter----------------------
localparam
    ADDR_C_V_DATA_0 = 5'h10,
    ADDR_C_V_DATA_1 = 5'h14,
    ADDR_C_V_CTRL   = 5'h18,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_C_V_DATA_1)
            int_C_V[63:32] <= (WDATA[31:0] & wmask) | (int_C_V[63:32] & ~wmask);
    end
end
